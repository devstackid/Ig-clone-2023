    ...
    <MainLayout>
            ...
            <div class="flex items-center md:justify-between">
                ...
                <div class="ml-6 w-full">
                    <div class="flex items-center md:mb-8 mb-5">
                        ...
                        <button class="md:block hidden md:mr-6 p-1 px-4 rounded-lg font-extrabold text-[16px] bg-gray-100 hover:bg-gray-200">
                            Edit Profile
                        </button>
                    ...
                    <div class="md:block hidden">
                        <div class="flex items-center text-[18px]">
                            ...
                            <div class="mr-6">
                                <span class="font-extrabold">341</span> Followers
                            </div>
                            <div class="mr-6">
                                <span class="font-extrabold">69</span> Following
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="md:hidden">
            <div class="w-full flex items-center justify-around border-t border-t-gray-300 mt-8">
                ...
                <div class="text-center p-3">
                    <div class="font-extrabold">431</div>
                    <div class="text-gray-400 font-semibold -mt-1 5">followers</div>
                </div>
                <div class="text-center p-3">
                    <div class="font-extrabold">69</div>
        ...
        <div id="ContentSection" class="md:pr-1.5 lg:pl-[90px]">
            <div class="md:block mt-10 hidden border-t border-t-gray-300">
                <div class="flex items-center justify-between mx-auto max-w-[600px] font-extrabold text-gray-400 text-[15px]">
