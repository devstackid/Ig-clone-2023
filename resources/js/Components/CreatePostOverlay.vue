...
const createPostFunc = () => {
    ...
    router.post('/posts', form, {
        ...
        preserveScroll: true,
        onError: errors => {
            onError && errors.text ? error.value.text = error.text : ''
            onError && errors.file ? error.value.file = error.file : ''
        },
        onSuccess: () => {
            closeOverlay()
            emit('close')
    ...
    <div id="OverlaySection" class="fixed z-50 top-0 left-0 w-full h-screen bg-[#000000] bg-opacity-60 p-3">
        ...
        <div class="max-w-6xl h-[calc(100%-100px)] mx-auto mt-10 bg-white rounded-xl">
            <div class="flex items-center justify-between w-full rounded-t-xl p-3 border-b border-b-gray-300">
                <ArrowLeft :size="30" fillColor="000000" class="cursor-pointer" @click="$event => closeOverlay()"/>
                ...
                <div id="TextAreaSection" class="max-w-[720px] w-full relative">
                    <div class="flex items-center justify-between p-3">
                        <div class="flex items-center">
                            <img class="rounded-full w-[38px] h-[38px]" src="http://picsum.photos/id/8/300/320">
                    ...
                    <div class="flex items-center justify-between border-p p-3">
