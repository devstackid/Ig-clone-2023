...
<template>
    <div id="MainLayout" class="w-full h-screen">
        <div v-if="$page.url === '/'" id="TopNavHome" class="fixed z-30 md:hidden block w-full bg-white h-[61px] border-b border-gray-300">
        ...
        <div v-if="$page.url !== '/'" id="TopNavUser" class="md:hidden fixed flex items-center justify-between z-30 w-full bg-white h-[61px] border-b border-gray-300">
        ...
        <div id="SideNav" class="fixed h-full xl:w-[280px] w-[80px] md:block hidden border-r border-r-gray-300 ">
            <Link href="/">
